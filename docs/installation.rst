...
Installation
============
Here, we detail the offline install process when it's too slow to install pytorch-nightly. You can download package and install it offline. 链接:<https://pan.baidu.com/s/1TvdmmVHwiWv9PqS86ZscJw>  密码:247j
